        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MetalType = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalOrdersFulfilled = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GrossWeightGrams = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    NetWeightGrams = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    MetalRatePerGramAtListing = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    Size = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SizeUnit = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MetalValue = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    MakingCharges = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    MakingChargesArePercentage = table.Column<bool>(type: "bit", nullable: false),
                    GemstoneValue = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    WastageCharges = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    ...
                    IsHallmarked = table.Column<bool>(type: "bit", nullable: false),
                    HallmarkUniqueId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CertificationAuthority = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    City = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    State = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    CreatedBySellerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    AnnualMembershipFee = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    RowVersion = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Unions_Sellers_CreatedBySellerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingCharges = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "ProductGemstones",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ProductId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    GemstoneType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    WeightCarats = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    ClarityGrade = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ColorGrade = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductGemstones", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductGemstones_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnionEvents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UnionEvents_Unions_UnionId",
                        column: x => x.UnionId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MembershipFeePaidThroughUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    RowVersion = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ModifiedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnionMembers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UnionMembers_Sellers_SellerId",
                        column: x => x.SellerId,
                        principalTable: "Sellers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UnionMembers_Unions_UnionId",
                        column: x => x.UnionId,
                        principalTable: "Unions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MetalRateSnapshot = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    UnitPriceSnapshot = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GatewayReferenceId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Meetings_UnionMembers_CreatedByMemberId",
                        column: x => x.CreatedByMemberId,
                        principalTable: "UnionMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Meetings_Unions_UnionId",
                        column: x => x.UnionId,
                        principalTable: "Unions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublishedByMemberId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    RowVersion = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnionAnnouncements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UnionAnnouncements_UnionMembers_PublishedByMemberId",
                        column: x => x.PublishedByMemberId,
                        principalTable: "UnionMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UnionAnnouncements_Unions_UnionId",
                        column: x => x.UnionId,
                        principalTable: "Unions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnionDocuments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UnionDocuments_UnionMembers_UploadedByMemberId",
                        column: x => x.UploadedByMemberId,
                        principalTable: "UnionMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UnionDocuments_Unions_UnionId",
                        column: x => x.UnionId,
                        principalTable: "Unions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowMultipleSelections = table.Column<bool>(type: "bit", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    CreatedByMemberId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnionPolls", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UnionPolls_UnionMembers_CreatedByMemberId",
                        column: x => x.CreatedByMemberId,
                        principalTable: "UnionMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UnionPolls_Unions_UnionId",
                        column: x => x.UnionId,
                        principalTable: "Unions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ComponentType = table.Column<int>(type: "int", nullable: false),
                    RatePercentageApplied = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderTaxes_OrderItems_OrderItemId",
                        column: x => x.OrderItemId,
                        principalTable: "OrderItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderTaxes_TaxRates_TaxRateId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Shipments_OrderItems_OrderItemId",
                        column: x => x.OrderItemId,
                        principalTable: "OrderItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MeetingId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UnionMemberId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "varbinary(max)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MeetingAttendees_UnionMembers_UnionMemberId",
                        column: x => x.UnionMemberId,
                        principalTable: "UnionMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PollOptions_UnionPolls_PollId",
                        column: x => x.PollId,
                        principalTable: "UnionPolls",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DecisionSummary = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MeetingMinutes_MeetingAgendaItems_AgendaItemId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MeetingMinutes_UnionMembers_RecordedByMemberId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PollVotes_UnionMembers_UnionMemberId",
                        column: x => x.UnionMemberId,
                        principalTable: "UnionMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ActionItems_MeetingMinutes_MeetingMinuteId",
                        column: x => x.MeetingMinuteId,
                        principalTable: "MeetingMinutes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActionItems_UnionMembers_ResponsibleMemberId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActionItems_MeetingMinuteId",
                table: "ActionItems",
                column: "MeetingMinuteId");

            migrationBuilder.CreateIndex(
                name: "IX_ActionItems_ResponsibleMemberId_Status",
                table: "ActionItems",
                columns: new[] { "ResponsibleMemberId", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerAddresses_State",
                table: "CustomerAddresses",
                column: "State");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MeetingAgendaItems_MeetingId_Status",
                table: "MeetingAgendaItems",
                columns: new[] { "MeetingId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_MeetingAttendees_MeetingId_UnionMemberId",
                table: "MeetingAttendees",
                columns: new[] { "MeetingId", "UnionMemberId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MeetingAttendees_UnionMemberId",
                table: "MeetingAttendees",
                column: "UnionMemberId");

            migrationBuilder.CreateIndex(
                name: "IX_MeetingMinutes_AgendaItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MeetingMinutes_RecordedByMemberId",
                table: "MeetingMinutes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Meetings_UnionId_ScheduledAtUtc",
                table: "Meetings",
                columns: new[] { "UnionId", "ScheduledAtUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_SellerId_ItemStatus",
                table: "OrderItems",
                columns: new[] { "SellerId", "ItemStatus" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderTaxes_OrderItemId",
                table: "OrderTaxes",
                column: "OrderItemId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderTaxes_TaxRateId",
                table: "OrderTaxes",
                column: "TaxRateId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PollVotes_PollOptionId_UnionMemberId",
                table: "PollVotes",
                columns: new[] { "PollOptionId", "UnionMemberId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PollVotes_UnionMemberId",
                table: "PollVotes",
                column: "UnionMemberId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductGemstones_ProductId",
                table: "ProductGemstones",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_MetalType_Purity",
                table: "Products",
                columns: new[] { "MetalType", "Purity" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_SellerId_IsApproved",
                table: "Reviews",
                columns: new[] { "SellerId", "IsApproved" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaxRates_IsActive_Applicability_EffectiveFromUtc_EffectiveToUtc",
                table: "TaxRates",
                columns: new[] { "IsActive", "Applicability", "EffectiveFromUtc", "EffectiveToUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_UnionAnnouncements_PublishedByMemberId",
                table: "UnionAnnouncements",
                column: "PublishedByMemberId");

            migrationBuilder.CreateIndex(
                name: "IX_UnionAnnouncements_UnionId_IsPinned_CreatedAtUtc",
                table: "UnionAnnouncements",
                columns: new[] { "UnionId", "IsPinned", "CreatedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_UnionDocuments_UnionId",
                table: "UnionDocuments",
                column: "UnionId");

            migrationBuilder.CreateIndex(
                name: "IX_UnionDocuments_UploadedByMemberId",
                table: "UnionDocuments",
                column: "UploadedByMemberId");

            migrationBuilder.CreateIndex(
                name: "IX_UnionEvents_UnionId_StartsAtUtc",
                table: "UnionEvents",
                columns: new[] { "UnionId", "StartsAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_UnionMembers_SellerId",
                table: "UnionMembers",
                column: "SellerId");

            migrationBuilder.CreateIndex(
                name: "IX_UnionMembers_UnionId_Role",
                table: "UnionMembers",
                columns: new[] { "UnionId", "Role" });

            migrationBuilder.CreateIndex(
                name: "IX_UnionMembers_UnionId_SellerId",
                table: "UnionMembers",
                columns: new[] { "UnionId", "SellerId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UnionPolls_CreatedByMemberId",
                table: "UnionPolls",
                column: "CreatedByMemberId");

            migrationBuilder.CreateIndex(
                name: "IX_UnionPolls_UnionId",
                table: "UnionPolls",
                column: "UnionId");

            migrationBuilder.CreateIndex(
                name: "IX_Unions_CreatedBySellerId",
                table: "Unions",
                column: "CreatedBySellerId");

            migrationBuilder.CreateIndex(
                name: "IX_Unions_State_City",
                table: "Unions",
